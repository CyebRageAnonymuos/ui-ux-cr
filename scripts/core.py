...
class EnhancedBM25:
    ...
    def _build_synonym_map(self):
        ...
        return {
            ...
            "dark": ["night", "midnight", "dim", "shadow", "noir", "obsidian", "black", "gloom", "shade", "twilight", "ebony", "inky", "pitch"],
            ...
            "creative": ["artistic", "innovative", "imaginative", "original", "unique", "experimental", "inventive", "visionary", "expressive", "ingenuity", "novel", "unconventional"],
            ...
            "gradient": ["transition", "blend", "fade", "shift", "morph", "flow", "gradation", "spectrum", "continuum", "scale", "ramp", "progression"],
            "animation": ["motion", "movement", "transition", "effect", "dynamic", "kinetic", "animated", "moving", "active", "lively", "spirited", "vivid"],
            "responsive": ["adaptive", "flexible", "fluid", "mobile-first", "adaptive", "progressive", "reactive", "adjustable", "versatile", "dynamic", "elastic", "pliable"],
            "accessible": ["inclusive", "usable", "a11y", "universal", "barrier-free", "compliant", "approachable", "available", "open", "reachable", "obtainable"],
            "ux": ["user experience", "usability", "interaction", "interface", "user-centered", "user-friendly", "human-centered", "ergonomic", "intuitive", "user research", "design thinking", "user journey"],
            ...
            "saas": ["software as a service", "cloud", "subscription", "platform", "app", "web app", "cloud software", "online service", "hosted", "b2b software", "enterprise software"],
            "ecommerce": ["e-commerce", "shop", "store", "retail", "marketplace", "commerce", "online store", "web shop", "shopping cart", "buy online", "eshop", "boutique"],
            "dashboard": ["admin", "panel", "control", "analytics", "overview", "monitor", "control panel", "admin panel", "reporting", "metrics", "kpi", "statistics"],
            "landing": ["homepage", "hero", "front page", "main page", "start page", "splash", "welcome page", "landing page", "entry page", "home", "cover", "introduction"],
            ...
            "creative": ["artistic", "innovative", "inventive", "imaginative", "original", "unconventional", "avant-garde", "progressive", "experimental"],
            "healthcare": ["medical", "health", "clinical", "hospital", "patient", "wellness", "healthcare", "health-tech", "medtech", "biotech", "pharma", "therapeutic"],
            "fintech": ["finance", "banking", "financial", "payment", "money", "crypto", "blockchain", "trading", "investment", "wealth", "payments"],
            "gaming": ["game", "gaming", "esports", "gamer", "interactive", "entertainment", "playstation", "xbox", "console", "video game"],
            "education": ["learning", "e-learning", "educational", "academic", "school", "training", "course", "university", "student", "teach", "classroom"],
            "food": ["restaurant", "culinary", "cooking", "gourmet", "dining", "cuisine", "grocery", "delivery", "kitchen", "chef"],
            "travel": ["tourism", "vacation", "hotel", "flight", "destination", "adventure", "holiday", "journey", "expedition", "wanderlust"],
            "real estate": ["property", "housing", "apartment", "building", "home", "commercial", "residential", "mortgage", "realtor", "rental"],
            "fashion": ["style", "clothing", "apparel", "couture", "trendy", "garment", "wearable", "fashionable", "vogue", "wardrobe"],
            ...
            "gradient": ["gradation", "color transition", "blend", "fade", "mesh gradient", "linear gradient", "radial gradient", "conic gradient"],
            ...
            "dark": ["dark theme", "dark mode", "night", "low light", "dark ui", "dark palette", "black", "obsidian", "midnight"],
            ...
            "animation": ["css animation", "keyframe animation", "transition", "ease", "motion design", "animated"],
            ...
            "chart": ["graph", "visualization", "chart component", "chart type", "data viz", "chart library", "chart pattern"],
            "icon": ["svg icon", "icon set", "iconography", "icon pack", "icon library", "icon component", "heroicons", "lucide"],
            "responsive": ["responsive design", "adaptive", "mobile-friendly", "breakpoints", "responsive layout", "responsive grid"],
            ...
            "dashboard": ["analytics", "statistics", "kpi", "metrics", "data", "dashboard ui", "dashboard design", "admin panel", "dashboard layout"],
    ...
    def _build_category_keywords(self):
        return {
            "healthcare": ["health", "medical", "hospital", "clinic", "patient", "doctor", "nurse", "pharmacy", "wellness"],
            "fintech": ["finance", "banking", "financial", "payment", "investment", "wealth", "trading", "crypto"],
            "gaming": ["game", "gaming", "esports", "play", "gamer", "console"],
            "education": ["learn", "course", "school", "university", "student", "teach", "training"],
            "ecommerce": ["shop", "store", "buy", "cart", "product", "price", "sell", "retail"],
            "saas": ["saas", "subscription", "cloud", "software", "platform"],
            "food": ["restaurant", "food", "menu", "kitchen", "culinary", "dining"],
            "travel": ["travel", "hotel", "flight", "tour", "vacation", "trip"],
            "realestate": ["property", "house", "apartment", "rent", "mortgage", "realtor"],
            "fashion": ["fashion", "clothing", "style", "boutique", "apparel", "wear"],
        }
...
def detect_domain(query):
    ...
    domain_keywords = {
        ...
        "chart": ["chart", "graph", "visualization", "trend", "bar", "pie", "scatter", "heatmap", "funnel", "data viz", "chart type"],
        "landing": ["landing", "page", "cta", "conversion", "hero", "testimonial", "pricing", "section", "above fold", "homepage"],
        ...
        "animation": ["animation", "transition", "motion", "keyframe", "easing", "spring", "parallax", "scroll reveal", "micro interaction"],
        "responsive": ["responsive", "breakpoint", "mobile", "tablet", "grid", "flex", "adaptive", "fluid", "responsive design"],
